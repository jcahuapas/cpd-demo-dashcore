...
################################################################################
@my_app.callback(Output('newUsername', 'className'),
...
################################################################################
@my_app.callback(Output('newPwd1', 'className'),
...
# CREATE USER BUTTON CLICK / FORM SUBMIT - RED BOX IF PASSWORD DOES NOT MATCH
################################################################################
@my_app.callback(Output('newPwd2', 'className'),
...
################################################################################
@my_app.callback(Output('newEmail', 'className'),
...
################################################################################
@my_app.callback(Output('createUserSuccess', 'children'),
